...
public class DoorController : MonoBehaviour {
    ...
    void Update() {
        ...
        {
            if (leftDoor.transform.localPosition.x <= -leftDoor.width * 1.51f && rightDoor.transform.localPosition.x >= rightDoor.width * 1.51f)
            {
                currentState = State.OPEN;

                leftDoor.transform.localPosition = new Vector3(-leftDoor.width * 1.51f, 0.0f, 0.0f);
                rightDoor.transform.localPosition = new Vector3(rightDoor.width * 1.51f, 0.0f, 0.0f);
            }
        }
